...
class StoreReportScheduleRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'day_of_week.required_if' => 'Please specify the day of week for weekly schedules.',
            'day_of_week.between' => 'The day of week must be between 0 (Sunday) and 6 (Saturday).',
            'day_of_month.required_if' => 'Please specify the day of month for monthly schedules.',
